// Zelda-style UI API header used by this project
...
// Avoid including UI internals in this public header to keep dependencies light.

// For ContextId and related UI types used in the public API, include the UI context header
// using a relative path like in the Zelda project so includes resolve from the include/ folder.
...
namespace recompui {
	...
	// Export registration used by main.cpp
