...
// Declarations used by SM64 build. Keep in sync with implementations in src/game/* where applicable.
...
// Implemented as recomp_get_autosave_enabled in src/game/recomp_api.cpp
